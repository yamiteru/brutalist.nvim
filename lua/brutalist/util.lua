local hsluv = require 'brutalist.hsluv'
...
function M.darken(hex, amount, bg)
  return M.blend(hex, bg or require'brutalist.colors'.black, { math.abs(amount), math.abs(amount), math.abs(amount) })
end

function M.lighten(hex, amount, fg)
  return M.blend(hex, fg or require'brutalist.colors'.white, { math.abs(amount), math.abs(amount), math.abs(amount) })
end
...
function M.colorize(fg, bg)
  -- https://github.com/anotherglitchinthematrix/brutalist/blob/master/src/base.js
