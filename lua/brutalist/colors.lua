local util = require 'brutalist.util'
...
local color_style
if vim.g.brutalist_style == 'default' then
  color_style = Default
elseif vim.g.brutalist_style == 'subtle' then
  color_style = Subtle
elseif vim.g.brutalist_style == 'amplified' then
  color_style = Amplified
elseif vim.g.brutalist_style == 'coolgray' then
  color_style = CoolGray
elseif vim.g.brutalist_style == 'photon' then
  color_style = Photon
elseif vim.g.brutalist_style == 'custom' then
  color_style = vim.g.brutalist_custom_style
else
  color_style = Default
end
